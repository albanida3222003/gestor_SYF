...
INSERT INTO `produccion` VALUES (1,'2024-01-10',6000,3,2,3),(2,'2024-01-10',6000,4,2,3),(3,'2024-01-11',6000,5,1,1),(4,'2024-01-11',6000,6,2,3),(5,'2024-01-12',6000,3,2,3),(6,'2024-01-12',6000,4,2,3),(7,'2024-01-13',6000,5,1,1),(8,'2024-01-13',6000,6,2,3),(9,'2025-01-20',5000,11,2,1),(10,'2025-01-20',1000,7,2,1),(11,'2025-01-20',10000,7,2,1),(12,'2025-01-20',1000,7,1,1);
...
/*!50003 DROP PROCEDURE IF EXISTS `obtener_ultimo_contrato` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtener_ultimo_contrato`(IN idEmpleado INT)
BEGIN
    SELECT * 
    FROM contrato 
...
-- Dump completed on 2025-01-20 16:20:40
