		...
		<div class="card bg-secondary p-4">
			<form action="EmpleadosController" method="POST">
				<input type="hidden" name="operacion" value="editar"> <input
					type="hidden" name="idEmpleados"
					value="<%=empleado.getIdEmpleados()%>">

				<div class="mb-3">
					<label class="form-label">Id</label> <input type="text"
						name="id" class="form-control"
						value="<%=empleado.getIdEmpleados()%>" required>
				</div>
				...
				<div class="mb-3">
					<label class="form-label">Sexo</label> <select name="sexo"
						...
						<option value="M"
							<%=empleado.getSexo().equals("M") ? "selected" : ""%>>Masculino</option>
						<option value="F"
							<%=empleado.getSexo().equals("F") ? "selected" : ""%>>Femenino</option>
					</select>
				</div>
